        ...
        <div class="row mt-3">
            <div class="col-sm-2">
                <div class="list-group">
                    ...
                    <a href="index.php?action=peminjamanBuku" class="list-group-item list-group-item-action " style="color: white; background-color:rgb(0, 0, 0);">Peminjaman</a>
            ...
            <div class="col-sm-10">
                <diV class="row mb-3">
                    <h2 class="title text-center mb-3"><b>Peminjaman Buku</b></h2>
                </diV>
                                        ...
                                        <div class='modal fade' id='pinjamBuku$nomor' tabindex='-1' aria-labelledby='pinjamBukuLabel' aria-hidden='true'>
                                            <div class='modal-dialog modal-dialog-centered'>
                                                <div class='modal-content'>
                                                    ...
                                                    <div class='modal-body'>
                                                        <form method='post' action='../public/index.php?action=prosesPinjam'>                                                        
                                                            <input type='hidden' id='id-buku-$nomor' name='id_buku' value='$row[id_buku]'>                                                
                                                            <div class='mb-3'>
                                                                <label for='judul-$nomor' class='form-label'>Judul Buku</label>
                                                                <input type='text' readonly class='form-control' id='judul-$nomor' name='judul' value='$row[judul]'>
                                                            </div>  
                                                            <div class='mb-3'>
                                                                <label for='id-anggota-$nomor' class='form-label'>ID Peminjam</label>
                                                                <input type='number' class='form-control' id='id-anggota-$nomor' name='id_anggota' required>
                                                            </div>                                                                                                                                                                           
                                                            <div class='mb-3'>
                                                                <label for='tanggal-pinjam-$nomor' class='form-label'>Tanggal Pinjam</label>
                                                                <input type='date' class='form-control' id='tanggal-pinjam-$nomor' name='tanggal_pinjam' required min='' onfocus='setToday(this)'>
                                                            </div>
                                                            <div class='mb-3'>
